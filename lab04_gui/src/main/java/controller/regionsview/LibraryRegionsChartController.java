...
public class LibraryRegionsChartController extends AbstractService implements Initializable, ControllerInterface {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void switchToCountryChart(ActionEvent actionEvent) throws IOException {
        String fxmlPath = "/chartview/country/libraryCountryChartView.fxml";
